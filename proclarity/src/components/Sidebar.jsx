...
import '../App.css'
import './Sidebar.css'
import { FaChartBar, FaHome, FaSignOutAlt, FaTasks, FaTimes, FaUser, FaUsers } from 'react-icons/fa'
    ...
    return (
        ...
        ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 `}>
            ...
            <nav className='flex flex-col m-4'>
                {navItems.map((item) => (
                    <a href="#" key={item.id} onClick={() => { setActive(item.id); item.onClick && item.onClick(); }}
