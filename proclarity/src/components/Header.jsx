...
const Header = ({isOpen,setIsOpen}) => {
    ...
    return (
        <>
            <header className="header bg-emerald-50 w-[full-8px] m-2 lg:ms-0 mb-0 rounded-lg shadow-lg flex justify-between items-center p-4 h-16 text-slate-600 dark:bg-slate-800 dark:text-emerald-100" >
